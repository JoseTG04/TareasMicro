...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6_Pin|GPIO_PIN_7_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0_Pin|GPIO_PIN_1_Pin|GPIO_PIN_4_Pin|GPIO_PIN_5_Pin;
